 ...
 * @export
 * @interface DateSegment31
 */
export interface DateSegment31 {
    /**
     * 
     * @type {string}
     * @memberof DateSegment31
     */
    'condition_type'?: DateSegment31ConditionTypeEnum;
    /**
...
type DateSegment31ConditionTypeEnum = 'Date'
type DateSegment31FieldEnum = 'timestamp_opt' | 'info_changed' | 'ecomm_date'
type DateSegment31OpEnum = 'greater' | 'less' | 'is' | 'not' | 'blank' | 'blank_not' | 'within' | 'notwithin'
