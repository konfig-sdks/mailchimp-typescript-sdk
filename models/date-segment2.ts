 ...
 * @export
 * @interface DateSegment2
 */
export interface DateSegment2 {
    /**
     * 
     * @type {string}
     * @memberof DateSegment2
     */
    'condition_type'?: DateSegment2ConditionTypeEnum;
    /**
...
type DateSegment2ConditionTypeEnum = 'Date'
type DateSegment2FieldEnum = 'timestamp_opt' | 'info_changed' | 'ecomm_date'
type DateSegment2OpEnum = 'greater' | 'less' | 'is' | 'not' | 'blank' | 'blank_not' | 'within' | 'notwithin'
