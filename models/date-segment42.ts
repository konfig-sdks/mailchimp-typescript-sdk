 ...
 * @export
 * @interface DateSegment42
 */
export interface DateSegment42 {
    /**
     * 
     * @type {string}
     * @memberof DateSegment42
     */
    'condition_type'?: DateSegment42ConditionTypeEnum;
    /**
...
type DateSegment42ConditionTypeEnum = 'Date'
type DateSegment42FieldEnum = 'timestamp_opt' | 'info_changed' | 'ecomm_date'
type DateSegment42OpEnum = 'greater' | 'less' | 'is' | 'not' | 'blank' | 'blank_not' | 'within' | 'notwithin'
