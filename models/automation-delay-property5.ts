 ...
 * @export
 * @interface AutomationDelayProperty5
 */
export interface AutomationDelayProperty5 {
    /**
     * The delay amount for an Automation email.
     * @type {number}
     * @memberof AutomationDelayProperty5
     */
    'amount'?: number;
    /**
     ...
     * @memberof AutomationDelayProperty5
     */
    'type'?: AutomationDelayProperty5TypeEnum;
    /**
     * Whether the delay settings describe before or after the delay action of an Automation email.
     * @type {string}
     * @memberof AutomationDelayProperty5
     */
    'direction'?: AutomationDelayProperty5DirectionEnum;
    /**
     * The action that triggers the delay of an Automation email.
     * @type {string}
     * @memberof AutomationDelayProperty5
     */
    'action'?: AutomationDelayProperty5ActionEnum;
    /**
