 ...
 * @export
 * @interface DateSegment4
 */
export interface DateSegment4 {
    /**
     * 
     * @type {string}
     * @memberof DateSegment4
     */
    'condition_type'?: DateSegment4ConditionTypeEnum;
    /**
...
type DateSegment4ConditionTypeEnum = 'Date'
type DateSegment4FieldEnum = 'timestamp_opt' | 'info_changed' | 'ecomm_date'
type DateSegment4OpEnum = 'greater' | 'less' | 'is' | 'not' | 'blank' | 'blank_not' | 'within' | 'notwithin'
