 ...
 * @export
 * @interface DateSegment1
 */
export interface DateSegment1 {
    /**
     * 
     * @type {string}
     * @memberof DateSegment1
     */
    'condition_type'?: DateSegment1ConditionTypeEnum;
    /**
...
type DateSegment1ConditionTypeEnum = 'Date'
type DateSegment1FieldEnum = 'timestamp_opt' | 'info_changed' | 'ecomm_date'
type DateSegment1OpEnum = 'greater' | 'less' | 'is' | 'not' | 'blank' | 'blank_not' | 'within' | 'notwithin'
