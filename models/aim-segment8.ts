 ...
 * @export
 * @interface AimSegment8
 */
export interface AimSegment8 {
    /**
     * 
     * @type {string}
     * @memberof AimSegment8
     */
    'condition_type'?: AimSegment8ConditionTypeEnum;
    /**
     * Segment by interaction with a specific campaign.
     * @type {string}
     * @memberof AimSegment8
     */
    'field'?: AimSegment8FieldEnum;
    /**
...
type AimSegment8ConditionTypeEnum = 'Aim'
type AimSegment8FieldEnum = 'aim'
type AimSegment8OpEnum = 'open' | 'click' | 'sent' | 'noopen' | 'noclick' | 'nosent'
