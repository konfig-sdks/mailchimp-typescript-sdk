...
export interface DateSegment {
     ...
     * 
     * @type {string}
     * @memberof DateSegment
     */
    'condition_type'?: DateSegmentConditionTypeEnum;
    /**
...
type DateSegmentConditionTypeEnum = 'Date'
type DateSegmentFieldEnum = 'timestamp_opt' | 'info_changed' | 'ecomm_date'
type DateSegmentOpEnum = 'greater' | 'less' | 'is' | 'not' | 'blank' | 'blank_not' | 'within' | 'notwithin'
