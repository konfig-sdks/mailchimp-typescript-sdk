 ...
 * @export
 * @interface DateSegment30
 */
export interface DateSegment30 {
    /**
     * 
     * @type {string}
     * @memberof DateSegment30
     */
    'condition_type'?: DateSegment30ConditionTypeEnum;
    /**
...
type DateSegment30ConditionTypeEnum = 'Date'
type DateSegment30FieldEnum = 'timestamp_opt' | 'info_changed' | 'ecomm_date'
type DateSegment30OpEnum = 'greater' | 'less' | 'is' | 'not' | 'blank' | 'blank_not' | 'within' | 'notwithin'
