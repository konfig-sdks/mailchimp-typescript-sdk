 ...
 * @export
 * @interface AimSegment16
 */
export interface AimSegment16 {
    /**
     * 
     * @type {string}
     * @memberof AimSegment16
     */
    'condition_type'?: AimSegment16ConditionTypeEnum;
    /**
     * Segment by interaction with a specific campaign.
     * @type {string}
     * @memberof AimSegment16
     */
    'field'?: AimSegment16FieldEnum;
    /**
...
type AimSegment16ConditionTypeEnum = 'Aim'
type AimSegment16FieldEnum = 'aim'
type AimSegment16OpEnum = 'open' | 'click' | 'sent' | 'noopen' | 'noclick' | 'nosent'
