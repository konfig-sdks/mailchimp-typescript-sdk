 ...
 * @export
 * @interface AimSegment12
 */
export interface AimSegment12 {
    /**
     * 
     * @type {string}
     * @memberof AimSegment12
     */
    'condition_type'?: AimSegment12ConditionTypeEnum;
    /**
     * Segment by interaction with a specific campaign.
     * @type {string}
     * @memberof AimSegment12
     */
    'field'?: AimSegment12FieldEnum;
    /**
...
type AimSegment12ConditionTypeEnum = 'Aim'
type AimSegment12FieldEnum = 'aim'
type AimSegment12OpEnum = 'open' | 'click' | 'sent' | 'noopen' | 'noclick' | 'nosent'
