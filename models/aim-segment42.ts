 ...
 * @export
 * @interface AimSegment42
 */
export interface AimSegment42 {
    /**
     * 
     * @type {string}
     * @memberof AimSegment42
     */
    'condition_type'?: AimSegment42ConditionTypeEnum;
    /**
     * Segment by interaction with a specific campaign.
     * @type {string}
     * @memberof AimSegment42
     */
    'field'?: AimSegment42FieldEnum;
    /**
...
type AimSegment42ConditionTypeEnum = 'Aim'
type AimSegment42FieldEnum = 'aim'
type AimSegment42OpEnum = 'open' | 'click' | 'sent' | 'noopen' | 'noclick' | 'nosent'
