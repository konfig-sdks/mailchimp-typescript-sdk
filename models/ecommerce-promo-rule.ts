...
export interface ECommercePromoRule {
     ...
     * @memberof ECommercePromoRule
     */
    'type'?: ECommercePromoRuleTypeEnum;
    /**
     * The target that the discount applies to.
     * @type {string}
     * @memberof ECommercePromoRule
     */
    'target'?: ECommercePromoRuleTargetEnum;
    /**
...
type ECommercePromoRuleTypeEnum = 'fixed' | 'percentage'
type ECommercePromoRuleTargetEnum = 'per_item' | 'total' | 'shipping'
