 ...
 * @export
 * @interface AimSegment4
 */
export interface AimSegment4 {
    /**
     * 
     * @type {string}
     * @memberof AimSegment4
     */
    'condition_type'?: AimSegment4ConditionTypeEnum;
    /**
     * Segment by interaction with a specific campaign.
     * @type {string}
     * @memberof AimSegment4
     */
    'field'?: AimSegment4FieldEnum;
    /**
...
type AimSegment4ConditionTypeEnum = 'Aim'
type AimSegment4FieldEnum = 'aim'
type AimSegment4OpEnum = 'open' | 'click' | 'sent' | 'noopen' | 'noclick' | 'nosent'
