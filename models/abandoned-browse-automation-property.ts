 ...
 * @export
 * @interface AbandonedBrowseAutomationProperty
 */
export interface AbandonedBrowseAutomationProperty {
    /**
     * Whether this store supports the abandonedBrowse automation.
     * @type {boolean}
     * @memberof AbandonedBrowseAutomationProperty
     */
     ...
     * @memberof AbandonedBrowseAutomationProperty
     */
    'status'?: AbandonedBrowseAutomationPropertyStatusEnum;
}

type AbandonedBrowseAutomationPropertyStatusEnum = 'save' | 'sending' | 'paused'
