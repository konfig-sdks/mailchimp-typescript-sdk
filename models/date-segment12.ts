 ...
 * @export
 * @interface DateSegment12
 */
export interface DateSegment12 {
    /**
     * 
     * @type {string}
     * @memberof DateSegment12
     */
    'condition_type'?: DateSegment12ConditionTypeEnum;
    /**
...
type DateSegment12ConditionTypeEnum = 'Date'
type DateSegment12FieldEnum = 'timestamp_opt' | 'info_changed' | 'ecomm_date'
type DateSegment12OpEnum = 'greater' | 'less' | 'is' | 'not' | 'blank' | 'blank_not' | 'within' | 'notwithin'
