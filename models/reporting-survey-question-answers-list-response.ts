 ...
 * 
 * @export
 * @interface ReportingSurveyQuestionAnswersListResponse
 */
export interface ReportingSurveyQuestionAnswersListResponse {
    /**
     * An array of answers for a question on the survey.
     * @type {Array<SurveyQuestionAnswer>}
     * @memberof ReportingSurveyQuestionAnswersListResponse
     */
