 ...
 * @export
 * @interface AimSegment40
 */
export interface AimSegment40 {
    /**
     * 
     * @type {string}
     * @memberof AimSegment40
     */
    'condition_type'?: AimSegment40ConditionTypeEnum;
    /**
     * Segment by interaction with a specific campaign.
     * @type {string}
     * @memberof AimSegment40
     */
    'field'?: AimSegment40FieldEnum;
    /**
...
type AimSegment40ConditionTypeEnum = 'Aim'
type AimSegment40FieldEnum = 'aim'
type AimSegment40OpEnum = 'open' | 'click' | 'sent' | 'noopen' | 'noclick' | 'nosent'
