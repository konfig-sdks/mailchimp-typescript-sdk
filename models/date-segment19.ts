 ...
 * @export
 * @interface DateSegment19
 */
export interface DateSegment19 {
    /**
     * 
     * @type {string}
     * @memberof DateSegment19
     */
    'condition_type'?: DateSegment19ConditionTypeEnum;
    /**
...
type DateSegment19ConditionTypeEnum = 'Date'
type DateSegment19FieldEnum = 'timestamp_opt' | 'info_changed' | 'ecomm_date'
type DateSegment19OpEnum = 'greater' | 'less' | 'is' | 'not' | 'blank' | 'blank_not' | 'within' | 'notwithin'
