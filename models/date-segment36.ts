 ...
 * @export
 * @interface DateSegment36
 */
export interface DateSegment36 {
    /**
     * 
     * @type {string}
     * @memberof DateSegment36
     */
    'condition_type'?: DateSegment36ConditionTypeEnum;
    /**
...
type DateSegment36ConditionTypeEnum = 'Date'
type DateSegment36FieldEnum = 'timestamp_opt' | 'info_changed' | 'ecomm_date'
type DateSegment36OpEnum = 'greater' | 'less' | 'is' | 'not' | 'blank' | 'blank_not' | 'within' | 'notwithin'
