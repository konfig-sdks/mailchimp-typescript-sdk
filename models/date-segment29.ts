 ...
 * @export
 * @interface DateSegment29
 */
export interface DateSegment29 {
    /**
     * 
     * @type {string}
     * @memberof DateSegment29
     */
    'condition_type'?: DateSegment29ConditionTypeEnum;
    /**
...
type DateSegment29ConditionTypeEnum = 'Date'
type DateSegment29FieldEnum = 'timestamp_opt' | 'info_changed' | 'ecomm_date'
type DateSegment29OpEnum = 'greater' | 'less' | 'is' | 'not' | 'blank' | 'blank_not' | 'within' | 'notwithin'
