 ...
 * @export
 * @interface DateSegment7
 */
export interface DateSegment7 {
    /**
     * 
     * @type {string}
     * @memberof DateSegment7
     */
    'condition_type'?: DateSegment7ConditionTypeEnum;
    /**
...
type DateSegment7ConditionTypeEnum = 'Date'
type DateSegment7FieldEnum = 'timestamp_opt' | 'info_changed' | 'ecomm_date'
type DateSegment7OpEnum = 'greater' | 'less' | 'is' | 'not' | 'blank' | 'blank_not' | 'within' | 'notwithin'
