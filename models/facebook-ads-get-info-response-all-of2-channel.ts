 ...
 * Channel settings
 * @export
 * @interface FacebookAdsGetInfoResponseAllOf2Channel
 */
export interface FacebookAdsGetInfoResponseAllOf2Channel {
    /**
     * Is this for facebook feed
     * @type {boolean}
     * @memberof FacebookAdsGetInfoResponseAllOf2Channel
     */
