 ...
 * @export
 * @interface AimSegment14
 */
export interface AimSegment14 {
    /**
     * 
     * @type {string}
     * @memberof AimSegment14
     */
    'condition_type'?: AimSegment14ConditionTypeEnum;
    /**
     * Segment by interaction with a specific campaign.
     * @type {string}
     * @memberof AimSegment14
     */
    'field'?: AimSegment14FieldEnum;
    /**
...
type AimSegment14ConditionTypeEnum = 'Aim'
type AimSegment14FieldEnum = 'aim'
type AimSegment14OpEnum = 'open' | 'click' | 'sent' | 'noopen' | 'noclick' | 'nosent'
