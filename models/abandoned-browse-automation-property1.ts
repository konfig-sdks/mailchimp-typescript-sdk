 ...
 * @export
 * @interface AbandonedBrowseAutomationProperty1
 */
export interface AbandonedBrowseAutomationProperty1 {
    /**
     * Whether this store supports the abandonedBrowse automation.
     * @type {boolean}
     * @memberof AbandonedBrowseAutomationProperty1
     */
     ...
     * @memberof AbandonedBrowseAutomationProperty1
     */
    'status'?: AbandonedBrowseAutomationProperty1StatusEnum;
}

type AbandonedBrowseAutomationProperty1StatusEnum = 'save' | 'sending' | 'paused'
