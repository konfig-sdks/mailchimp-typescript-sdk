 ...
 * @export
 * @interface DateSegment21
 */
export interface DateSegment21 {
    /**
     * 
     * @type {string}
     * @memberof DateSegment21
     */
    'condition_type'?: DateSegment21ConditionTypeEnum;
    /**
...
type DateSegment21ConditionTypeEnum = 'Date'
type DateSegment21FieldEnum = 'timestamp_opt' | 'info_changed' | 'ecomm_date'
type DateSegment21OpEnum = 'greater' | 'less' | 'is' | 'not' | 'blank' | 'blank_not' | 'within' | 'notwithin'
