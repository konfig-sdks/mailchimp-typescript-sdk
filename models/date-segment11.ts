 ...
 * @export
 * @interface DateSegment11
 */
export interface DateSegment11 {
    /**
     * 
     * @type {string}
     * @memberof DateSegment11
     */
    'condition_type'?: DateSegment11ConditionTypeEnum;
    /**
...
type DateSegment11ConditionTypeEnum = 'Date'
type DateSegment11FieldEnum = 'timestamp_opt' | 'info_changed' | 'ecomm_date'
type DateSegment11OpEnum = 'greater' | 'less' | 'is' | 'not' | 'blank' | 'blank_not' | 'within' | 'notwithin'
