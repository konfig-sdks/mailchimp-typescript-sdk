...
import { AutomationDelayProperty2 } from './automation-delay-property2';
...
import { ListProperty10 } from './list-property10';
import { ResourceLink } from './resource-link';

/**
 * A summary of an individual Automation workflow email.
 * @export
 * @interface AutomationWorkflowEmail1
 */
export interface AutomationWorkflowEmail1 {
    /**
     * A string that uniquely identifies the Automation email.
     * @type {string}
     * @memberof AutomationWorkflowEmail1
     */
    'id'?: string;
    /**
    ...
    /**
     * 
     * @type {AutomationDelayProperty2}
     * @memberof AutomationWorkflowEmail1
     */
    'delay'?: AutomationDelayProperty2;
    /**
     ...
     * @memberof AutomationWorkflowEmail1
     */
    'status'?: AutomationWorkflowEmail1StatusEnum;
    /**
...
type AutomationWorkflowEmail1StatusEnum = 'save' | 'paused' | 'sending'
