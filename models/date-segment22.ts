 ...
 * @export
 * @interface DateSegment22
 */
export interface DateSegment22 {
    /**
     * 
     * @type {string}
     * @memberof DateSegment22
     */
    'condition_type'?: DateSegment22ConditionTypeEnum;
    /**
...
type DateSegment22ConditionTypeEnum = 'Date'
type DateSegment22FieldEnum = 'timestamp_opt' | 'info_changed' | 'ecomm_date'
type DateSegment22OpEnum = 'greater' | 'less' | 'is' | 'not' | 'blank' | 'blank_not' | 'within' | 'notwithin'
