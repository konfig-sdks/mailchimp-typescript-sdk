 ...
 * @export
 * @interface VerifiedDomainsAddDomainToAccountResponse
 */
export interface VerifiedDomainsAddDomainToAccountResponse {
    /**
     * The name of this domain.
     * @type {string}
     * @memberof VerifiedDomainsAddDomainToAccountResponse
     */
    'domain'?: string;
    /**
