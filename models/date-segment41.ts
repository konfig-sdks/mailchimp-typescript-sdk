 ...
 * @export
 * @interface DateSegment41
 */
export interface DateSegment41 {
    /**
     * 
     * @type {string}
     * @memberof DateSegment41
     */
    'condition_type'?: DateSegment41ConditionTypeEnum;
    /**
...
type DateSegment41ConditionTypeEnum = 'Date'
type DateSegment41FieldEnum = 'timestamp_opt' | 'info_changed' | 'ecomm_date'
type DateSegment41OpEnum = 'greater' | 'less' | 'is' | 'not' | 'blank' | 'blank_not' | 'within' | 'notwithin'
