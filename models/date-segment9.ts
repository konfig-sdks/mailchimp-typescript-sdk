 ...
 * @export
 * @interface DateSegment9
 */
export interface DateSegment9 {
    /**
     * 
     * @type {string}
     * @memberof DateSegment9
     */
    'condition_type'?: DateSegment9ConditionTypeEnum;
    /**
...
type DateSegment9ConditionTypeEnum = 'Date'
type DateSegment9FieldEnum = 'timestamp_opt' | 'info_changed' | 'ecomm_date'
type DateSegment9OpEnum = 'greater' | 'less' | 'is' | 'not' | 'blank' | 'blank_not' | 'within' | 'notwithin'
