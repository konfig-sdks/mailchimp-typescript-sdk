...
import { SubscriberStatsProperty1 } from './subscriber-stats-property1';
import { TagsPropertyInner } from './tags-property-inner';

/**
 * Individuals who are currently or have been previously subscribed to this list, including members who have bounced or unsubscribed.
 * @export
 * @interface ListMembers2
 */
export interface ListMembers2 {
    /**
     ...
     * @memberof ListMembers2
     */
    'sms_subscription_status'?: ListMembers2SmsSubscriptionStatusEnum;
    /**
    ...
    /**
     * 
     * @type {SubscriberStatsProperty1}
     * @memberof ListMembers2
     */
    'stats'?: SubscriberStatsProperty1;
    /**
...
type ListMembers2StatusEnum = 'subscribed' | 'unsubscribed' | 'cleaned' | 'pending' | 'transactional' | 'archived'
type ListMembers2SmsSubscriptionStatusEnum = 'subscribed' | 'unsubscribed' | 'nonsubscribed' | 'pending'
