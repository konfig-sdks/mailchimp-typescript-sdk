 ...
 * @export
 * @interface DateSegment23
 */
export interface DateSegment23 {
    /**
     * 
     * @type {string}
     * @memberof DateSegment23
     */
    'condition_type'?: DateSegment23ConditionTypeEnum;
    /**
...
type DateSegment23ConditionTypeEnum = 'Date'
type DateSegment23FieldEnum = 'timestamp_opt' | 'info_changed' | 'ecomm_date'
type DateSegment23OpEnum = 'greater' | 'less' | 'is' | 'not' | 'blank' | 'blank_not' | 'within' | 'notwithin'
