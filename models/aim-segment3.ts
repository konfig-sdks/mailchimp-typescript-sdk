 ...
 * @export
 * @interface AimSegment3
 */
export interface AimSegment3 {
    /**
     * 
     * @type {string}
     * @memberof AimSegment3
     */
    'condition_type'?: AimSegment3ConditionTypeEnum;
    /**
     * Segment by interaction with a specific campaign.
     * @type {string}
     * @memberof AimSegment3
     */
    'field'?: AimSegment3FieldEnum;
    /**
...
type AimSegment3ConditionTypeEnum = 'Aim'
type AimSegment3FieldEnum = 'aim'
type AimSegment3OpEnum = 'open' | 'click' | 'sent' | 'noopen' | 'noclick' | 'nosent'
