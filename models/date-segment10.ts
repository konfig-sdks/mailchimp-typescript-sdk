 ...
 * @export
 * @interface DateSegment10
 */
export interface DateSegment10 {
    /**
     * 
     * @type {string}
     * @memberof DateSegment10
     */
    'condition_type'?: DateSegment10ConditionTypeEnum;
    /**
...
type DateSegment10ConditionTypeEnum = 'Date'
type DateSegment10FieldEnum = 'timestamp_opt' | 'info_changed' | 'ecomm_date'
type DateSegment10OpEnum = 'greater' | 'less' | 'is' | 'not' | 'blank' | 'blank_not' | 'within' | 'notwithin'
