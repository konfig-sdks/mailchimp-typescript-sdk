 ...
 * @export
 * @interface DateSegment6
 */
export interface DateSegment6 {
    /**
     * 
     * @type {string}
     * @memberof DateSegment6
     */
    'condition_type'?: DateSegment6ConditionTypeEnum;
    /**
...
type DateSegment6ConditionTypeEnum = 'Date'
type DateSegment6FieldEnum = 'timestamp_opt' | 'info_changed' | 'ecomm_date'
type DateSegment6OpEnum = 'greater' | 'less' | 'is' | 'not' | 'blank' | 'blank_not' | 'within' | 'notwithin'
