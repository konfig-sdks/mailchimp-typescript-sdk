 ...
 * @export
 * @interface DateSegment37
 */
export interface DateSegment37 {
    /**
     * 
     * @type {string}
     * @memberof DateSegment37
     */
    'condition_type'?: DateSegment37ConditionTypeEnum;
    /**
...
type DateSegment37ConditionTypeEnum = 'Date'
type DateSegment37FieldEnum = 'timestamp_opt' | 'info_changed' | 'ecomm_date'
type DateSegment37OpEnum = 'greater' | 'less' | 'is' | 'not' | 'blank' | 'blank_not' | 'within' | 'notwithin'
