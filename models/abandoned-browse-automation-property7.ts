 ...
 * @export
 * @interface AbandonedBrowseAutomationProperty7
 */
export interface AbandonedBrowseAutomationProperty7 {
    /**
     * Whether this store supports the abandonedBrowse automation.
     * @type {boolean}
     * @memberof AbandonedBrowseAutomationProperty7
     */
     ...
     * @memberof AbandonedBrowseAutomationProperty7
     */
    'status'?: AbandonedBrowseAutomationProperty7StatusEnum;
}

type AbandonedBrowseAutomationProperty7StatusEnum = 'save' | 'sending' | 'paused'
