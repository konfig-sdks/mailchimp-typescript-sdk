 ...
 * @export
 * @interface DateSegment13
 */
export interface DateSegment13 {
    /**
     * 
     * @type {string}
     * @memberof DateSegment13
     */
    'condition_type'?: DateSegment13ConditionTypeEnum;
    /**
...
type DateSegment13ConditionTypeEnum = 'Date'
type DateSegment13FieldEnum = 'timestamp_opt' | 'info_changed' | 'ecomm_date'
type DateSegment13OpEnum = 'greater' | 'less' | 'is' | 'not' | 'blank' | 'blank_not' | 'within' | 'notwithin'
