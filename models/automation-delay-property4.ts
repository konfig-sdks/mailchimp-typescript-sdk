 ...
 * @export
 * @interface AutomationDelayProperty4
 */
export interface AutomationDelayProperty4 {
    /**
     * The delay amount for an Automation email.
     * @type {number}
     * @memberof AutomationDelayProperty4
     */
    'amount'?: number;
    /**
     ...
     * @memberof AutomationDelayProperty4
     */
    'type'?: AutomationDelayProperty4TypeEnum;
    /**
     * Whether the delay settings describe before or after the delay action of an Automation email.
     * @type {string}
     * @memberof AutomationDelayProperty4
     */
    'direction'?: AutomationDelayProperty4DirectionEnum;
    /**
     * The action that triggers the delay of an Automation email.
     * @type {string}
     * @memberof AutomationDelayProperty4
     */
    'action'?: AutomationDelayProperty4ActionEnum;
    /**
