 ...
 * @export
 * @interface FileManagerUpdateSpecificFolder200Response
 */
export interface FileManagerUpdateSpecificFolder200Response {
    /**
     * The unique id for the folder.
     * @type {number}
     * @memberof FileManagerUpdateSpecificFolder200Response
     */
    'id'?: number;
    /**
