 ...
 * @export
 * @interface AimSegment1
 */
export interface AimSegment1 {
    /**
     * 
     * @type {string}
     * @memberof AimSegment1
     */
    'condition_type'?: AimSegment1ConditionTypeEnum;
    /**
     * Segment by interaction with a specific campaign.
     * @type {string}
     * @memberof AimSegment1
     */
    'field'?: AimSegment1FieldEnum;
    /**
...
type AimSegment1ConditionTypeEnum = 'Aim'
type AimSegment1FieldEnum = 'aim'
type AimSegment1OpEnum = 'open' | 'click' | 'sent' | 'noopen' | 'noclick' | 'nosent'
