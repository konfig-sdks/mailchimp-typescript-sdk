 ...
 * @export
 * @interface EcommerceUpdatePromoRuleResponse
 */
export interface EcommerceUpdatePromoRuleResponse {
    /**
     * The title that will show up in promotion campaign. Restricted to UTF-8 characters with max length of 100 bytes.
     * @type {string}
     * @memberof EcommerceUpdatePromoRuleResponse
     */
    'title'?: string;
    /**
     ...
     * @memberof EcommerceUpdatePromoRuleResponse
     */
    'type'?: EcommerceUpdatePromoRuleResponseTypeEnum;
    /**
     * The target that the discount applies to.
     * @type {string}
     * @memberof EcommerceUpdatePromoRuleResponse
     */
    'target'?: EcommerceUpdatePromoRuleResponseTargetEnum;
    /**
...
type EcommerceUpdatePromoRuleResponseTypeEnum = 'fixed' | 'percentage'
type EcommerceUpdatePromoRuleResponseTargetEnum = 'per_item' | 'total' | 'shipping'
