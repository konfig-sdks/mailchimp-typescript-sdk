 ...
 * @export
 * @interface TemplatesGetInfoResponse
 */
export interface TemplatesGetInfoResponse {
    /**
     * The individual id for the template.
     * @type {number}
     * @memberof TemplatesGetInfoResponse
     */
    'id'?: number;
    /**
     ...
     * @memberof TemplatesGetInfoResponse
     */
    'content_type'?: TemplatesGetInfoResponseContentTypeEnum;
    /**
...
type TemplatesGetInfoResponseContentTypeEnum = 'template' | 'multichannel' | 'html'
