 ...
 * @export
 * @interface ConversationsListMessagesFromConversationResponse
 */
export interface ConversationsListMessagesFromConversationResponse {
    /**
     * An array of objects, each representing a conversation messages resources.
     * @type {Array<ConversationMessage>}
     * @memberof ConversationsListMessagesFromConversationResponse
     */
