 ...
 * @export
 * @interface AimSegment2
 */
export interface AimSegment2 {
    /**
     * 
     * @type {string}
     * @memberof AimSegment2
     */
    'condition_type'?: AimSegment2ConditionTypeEnum;
    /**
     * Segment by interaction with a specific campaign.
     * @type {string}
     * @memberof AimSegment2
     */
    'field'?: AimSegment2FieldEnum;
    /**
...
type AimSegment2ConditionTypeEnum = 'Aim'
type AimSegment2FieldEnum = 'aim'
type AimSegment2OpEnum = 'open' | 'click' | 'sent' | 'noopen' | 'noclick' | 'nosent'
