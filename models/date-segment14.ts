 ...
 * @export
 * @interface DateSegment14
 */
export interface DateSegment14 {
    /**
     * 
     * @type {string}
     * @memberof DateSegment14
     */
    'condition_type'?: DateSegment14ConditionTypeEnum;
    /**
...
type DateSegment14ConditionTypeEnum = 'Date'
type DateSegment14FieldEnum = 'timestamp_opt' | 'info_changed' | 'ecomm_date'
type DateSegment14OpEnum = 'greater' | 'less' | 'is' | 'not' | 'blank' | 'blank_not' | 'within' | 'notwithin'
