 ...
 * @export
 * @interface SurveyQuestionReport1
 */
export interface SurveyQuestionReport1 {
    /**
     * The ID of the survey question.
     * @type {string}
     * @memberof SurveyQuestionReport1
     */
    'id'?: string;
    /**
     ...
     * @memberof SurveyQuestionReport1
     */
    'type'?: SurveyQuestionReport1TypeEnum;
    /**
...
type SurveyQuestionReport1TypeEnum = 'pickOne' | 'pickMany' | 'range' | 'text' | 'email'
