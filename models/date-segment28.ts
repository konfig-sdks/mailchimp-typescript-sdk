 ...
 * @export
 * @interface DateSegment28
 */
export interface DateSegment28 {
    /**
     * 
     * @type {string}
     * @memberof DateSegment28
     */
    'condition_type'?: DateSegment28ConditionTypeEnum;
    /**
...
type DateSegment28ConditionTypeEnum = 'Date'
type DateSegment28FieldEnum = 'timestamp_opt' | 'info_changed' | 'ecomm_date'
type DateSegment28OpEnum = 'greater' | 'less' | 'is' | 'not' | 'blank' | 'blank_not' | 'within' | 'notwithin'
