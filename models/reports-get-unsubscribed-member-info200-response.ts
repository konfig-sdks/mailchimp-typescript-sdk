 ...
 * @export
 * @interface ReportsGetUnsubscribedMemberInfo200Response
 */
export interface ReportsGetUnsubscribedMemberInfo200Response {
    /**
     * The MD5 hash of the lowercase version of the list member\'s email address.
     * @type {string}
     * @memberof ReportsGetUnsubscribedMemberInfo200Response
     */
    'email_id'?: string;
    /**
