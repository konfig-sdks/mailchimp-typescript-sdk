 ...
 * @export
 * @interface EcommerceAddPromoRuleResponse
 */
export interface EcommerceAddPromoRuleResponse {
    /**
     * The title that will show up in promotion campaign. Restricted to UTF-8 characters with max length of 100 bytes.
     * @type {string}
     * @memberof EcommerceAddPromoRuleResponse
     */
    'title'?: string;
    /**
     ...
     * @memberof EcommerceAddPromoRuleResponse
     */
    'type'?: EcommerceAddPromoRuleResponseTypeEnum;
    /**
     * The target that the discount applies to.
     * @type {string}
     * @memberof EcommerceAddPromoRuleResponse
     */
    'target'?: EcommerceAddPromoRuleResponseTargetEnum;
    /**
...
type EcommerceAddPromoRuleResponseTypeEnum = 'fixed' | 'percentage'
type EcommerceAddPromoRuleResponseTargetEnum = 'per_item' | 'total' | 'shipping'
