 ...
 * @export
 * @interface DateSegment25
 */
export interface DateSegment25 {
    /**
     * 
     * @type {string}
     * @memberof DateSegment25
     */
    'condition_type'?: DateSegment25ConditionTypeEnum;
    /**
...
type DateSegment25ConditionTypeEnum = 'Date'
type DateSegment25FieldEnum = 'timestamp_opt' | 'info_changed' | 'ecomm_date'
type DateSegment25OpEnum = 'greater' | 'less' | 'is' | 'not' | 'blank' | 'blank_not' | 'within' | 'notwithin'
