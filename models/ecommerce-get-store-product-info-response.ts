...
import { ECommerceProductVariant6 } from './ecommerce-product-variant6';
import { ResourceLink } from './resource-link';

/**
 * Information about a specific product.
 * @export
 * @interface EcommerceGetStoreProductInfoResponse
 */
export interface EcommerceGetStoreProductInfoResponse {
    /**
     * The title of a product.
     * @type {string}
     * @memberof EcommerceGetStoreProductInfoResponse
     */
    'title'?: string;
    /**
     ...
     * @type {Array<ECommerceProductVariant6>}
     * @memberof EcommerceGetStoreProductInfoResponse
     */
    'variants'?: Array<ECommerceProductVariant6>;
    /**
