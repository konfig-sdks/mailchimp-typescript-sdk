 ...
 * @export
 * @interface AimSegment37
 */
export interface AimSegment37 {
    /**
     * 
     * @type {string}
     * @memberof AimSegment37
     */
    'condition_type'?: AimSegment37ConditionTypeEnum;
    /**
     * Segment by interaction with a specific campaign.
     * @type {string}
     * @memberof AimSegment37
     */
    'field'?: AimSegment37FieldEnum;
    /**
...
type AimSegment37ConditionTypeEnum = 'Aim'
type AimSegment37FieldEnum = 'aim'
type AimSegment37OpEnum = 'open' | 'click' | 'sent' | 'noopen' | 'noclick' | 'nosent'
