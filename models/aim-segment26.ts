 ...
 * @export
 * @interface AimSegment26
 */
export interface AimSegment26 {
    /**
     * 
     * @type {string}
     * @memberof AimSegment26
     */
    'condition_type'?: AimSegment26ConditionTypeEnum;
    /**
     * Segment by interaction with a specific campaign.
     * @type {string}
     * @memberof AimSegment26
     */
    'field'?: AimSegment26FieldEnum;
    /**
...
type AimSegment26ConditionTypeEnum = 'Aim'
type AimSegment26FieldEnum = 'aim'
type AimSegment26OpEnum = 'open' | 'click' | 'sent' | 'noopen' | 'noclick' | 'nosent'
