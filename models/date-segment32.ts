 ...
 * @export
 * @interface DateSegment32
 */
export interface DateSegment32 {
    /**
     * 
     * @type {string}
     * @memberof DateSegment32
     */
    'condition_type'?: DateSegment32ConditionTypeEnum;
    /**
...
type DateSegment32ConditionTypeEnum = 'Date'
type DateSegment32FieldEnum = 'timestamp_opt' | 'info_changed' | 'ecomm_date'
type DateSegment32OpEnum = 'greater' | 'less' | 'is' | 'not' | 'blank' | 'blank_not' | 'within' | 'notwithin'
