 ...
 * @export
 * @interface ConversationsGetMessageById200Response
 */
export interface ConversationsGetMessageById200Response {
    /**
     * A string that uniquely identifies this message
     * @type {string}
     * @memberof ConversationsGetMessageById200Response
     */
    'id'?: string;
    /**
