 ...
 * 
 * @export
 * @interface PromosPropertyInner1
 */
export interface PromosPropertyInner1 {
    /**
     * The Promo Code
     * @type {string}
     * @memberof PromosPropertyInner1
     */
    'code'?: string;
    /**
     ...
     * @memberof PromosPropertyInner1
     */
    'type'?: PromosPropertyInner1TypeEnum;
}

type PromosPropertyInner1TypeEnum = 'fixed' | 'percentage'
