 ...
 * @export
 * @interface ReportsGetSubscriberActivity200Response
 */
export interface ReportsGetSubscriberActivity200Response {
    /**
     * The unique id for the campaign.
     * @type {string}
     * @memberof ReportsGetSubscriberActivity200Response
     */
    'campaign_id'?: string;
    /**
