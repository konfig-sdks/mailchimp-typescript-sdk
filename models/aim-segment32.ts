 ...
 * @export
 * @interface AimSegment32
 */
export interface AimSegment32 {
    /**
     * 
     * @type {string}
     * @memberof AimSegment32
     */
    'condition_type'?: AimSegment32ConditionTypeEnum;
    /**
     * Segment by interaction with a specific campaign.
     * @type {string}
     * @memberof AimSegment32
     */
    'field'?: AimSegment32FieldEnum;
    /**
...
type AimSegment32ConditionTypeEnum = 'Aim'
type AimSegment32FieldEnum = 'aim'
type AimSegment32OpEnum = 'open' | 'click' | 'sent' | 'noopen' | 'noclick' | 'nosent'
