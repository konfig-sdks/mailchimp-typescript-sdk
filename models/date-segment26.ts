 ...
 * @export
 * @interface DateSegment26
 */
export interface DateSegment26 {
    /**
     * 
     * @type {string}
     * @memberof DateSegment26
     */
    'condition_type'?: DateSegment26ConditionTypeEnum;
    /**
...
type DateSegment26ConditionTypeEnum = 'Date'
type DateSegment26FieldEnum = 'timestamp_opt' | 'info_changed' | 'ecomm_date'
type DateSegment26OpEnum = 'greater' | 'less' | 'is' | 'not' | 'blank' | 'blank_not' | 'within' | 'notwithin'
