 ...
 * @export
 * @interface DateSegment18
 */
export interface DateSegment18 {
    /**
     * 
     * @type {string}
     * @memberof DateSegment18
     */
    'condition_type'?: DateSegment18ConditionTypeEnum;
    /**
...
type DateSegment18ConditionTypeEnum = 'Date'
type DateSegment18FieldEnum = 'timestamp_opt' | 'info_changed' | 'ecomm_date'
type DateSegment18OpEnum = 'greater' | 'less' | 'is' | 'not' | 'blank' | 'blank_not' | 'within' | 'notwithin'
