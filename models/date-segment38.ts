 ...
 * @export
 * @interface DateSegment38
 */
export interface DateSegment38 {
    /**
     * 
     * @type {string}
     * @memberof DateSegment38
     */
    'condition_type'?: DateSegment38ConditionTypeEnum;
    /**
...
type DateSegment38ConditionTypeEnum = 'Date'
type DateSegment38FieldEnum = 'timestamp_opt' | 'info_changed' | 'ecomm_date'
type DateSegment38OpEnum = 'greater' | 'less' | 'is' | 'not' | 'blank' | 'blank_not' | 'within' | 'notwithin'
