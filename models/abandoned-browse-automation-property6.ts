 ...
 * @export
 * @interface AbandonedBrowseAutomationProperty6
 */
export interface AbandonedBrowseAutomationProperty6 {
    /**
     * Whether this store supports the abandonedBrowse automation.
     * @type {boolean}
     * @memberof AbandonedBrowseAutomationProperty6
     */
     ...
     * @memberof AbandonedBrowseAutomationProperty6
     */
    'status'?: AbandonedBrowseAutomationProperty6StatusEnum;
}

type AbandonedBrowseAutomationProperty6StatusEnum = 'save' | 'sending' | 'paused'
