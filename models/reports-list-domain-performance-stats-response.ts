 ...
 * @export
 * @interface ReportsListDomainPerformanceStatsResponse
 */
export interface ReportsListDomainPerformanceStatsResponse {
    /**
     * The top 5 email domains based on total delivered emails.
     * @type {Array<EmailDomain>}
     * @memberof ReportsListDomainPerformanceStatsResponse
     */
