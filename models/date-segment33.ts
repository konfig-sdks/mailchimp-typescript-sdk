 ...
 * @export
 * @interface DateSegment33
 */
export interface DateSegment33 {
    /**
     * 
     * @type {string}
     * @memberof DateSegment33
     */
    'condition_type'?: DateSegment33ConditionTypeEnum;
    /**
...
type DateSegment33ConditionTypeEnum = 'Date'
type DateSegment33FieldEnum = 'timestamp_opt' | 'info_changed' | 'ecomm_date'
type DateSegment33OpEnum = 'greater' | 'less' | 'is' | 'not' | 'blank' | 'blank_not' | 'within' | 'notwithin'
