 ...
 * @export
 * @interface DateSegment27
 */
export interface DateSegment27 {
    /**
     * 
     * @type {string}
     * @memberof DateSegment27
     */
    'condition_type'?: DateSegment27ConditionTypeEnum;
    /**
...
type DateSegment27ConditionTypeEnum = 'Date'
type DateSegment27FieldEnum = 'timestamp_opt' | 'info_changed' | 'ecomm_date'
type DateSegment27OpEnum = 'greater' | 'less' | 'is' | 'not' | 'blank' | 'blank_not' | 'within' | 'notwithin'
