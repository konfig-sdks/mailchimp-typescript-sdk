 ...
 * @export
 * @interface AimSegment18
 */
export interface AimSegment18 {
    /**
     * 
     * @type {string}
     * @memberof AimSegment18
     */
    'condition_type'?: AimSegment18ConditionTypeEnum;
    /**
     * Segment by interaction with a specific campaign.
     * @type {string}
     * @memberof AimSegment18
     */
    'field'?: AimSegment18FieldEnum;
    /**
...
type AimSegment18ConditionTypeEnum = 'Aim'
type AimSegment18FieldEnum = 'aim'
type AimSegment18OpEnum = 'open' | 'click' | 'sent' | 'noopen' | 'noclick' | 'nosent'
