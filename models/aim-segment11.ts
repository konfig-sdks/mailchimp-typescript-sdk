 ...
 * @export
 * @interface AimSegment11
 */
export interface AimSegment11 {
    /**
     * 
     * @type {string}
     * @memberof AimSegment11
     */
    'condition_type'?: AimSegment11ConditionTypeEnum;
    /**
     * Segment by interaction with a specific campaign.
     * @type {string}
     * @memberof AimSegment11
     */
    'field'?: AimSegment11FieldEnum;
    /**
...
type AimSegment11ConditionTypeEnum = 'Aim'
type AimSegment11FieldEnum = 'aim'
type AimSegment11OpEnum = 'open' | 'click' | 'sent' | 'noopen' | 'noclick' | 'nosent'
