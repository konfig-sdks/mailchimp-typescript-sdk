 ...
 * @export
 * @interface AimSegment24
 */
export interface AimSegment24 {
    /**
     * 
     * @type {string}
     * @memberof AimSegment24
     */
    'condition_type'?: AimSegment24ConditionTypeEnum;
    /**
     * Segment by interaction with a specific campaign.
     * @type {string}
     * @memberof AimSegment24
     */
    'field'?: AimSegment24FieldEnum;
    /**
...
type AimSegment24ConditionTypeEnum = 'Aim'
type AimSegment24FieldEnum = 'aim'
type AimSegment24OpEnum = 'open' | 'click' | 'sent' | 'noopen' | 'noclick' | 'nosent'
