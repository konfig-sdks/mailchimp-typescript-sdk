 ...
 * 
 * @export
 * @interface FacebookAdsListAdsResponseFacebookAdsInnerAllOf1
 */
export interface FacebookAdsListAdsResponseFacebookAdsInnerAllOf1 {
    /**
     * 
     * @type {string}
     * @memberof FacebookAdsListAdsResponseFacebookAdsInnerAllOf1
     */
