 ...
 * @export
 * @interface ReportingListFacebookEcommerceReportResponse
 */
export interface ReportingListFacebookEcommerceReportResponse {
    /**
     * 
     * @type {Array<ReportsGetCampaignProductActivityResponseProductsInner>}
     * @memberof ReportingListFacebookEcommerceReportResponse
     */
