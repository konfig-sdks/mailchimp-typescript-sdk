 ...
 * @export
 * @interface EcommerceGetStorePromoRule200Response
 */
export interface EcommerceGetStorePromoRule200Response {
    /**
     * The title that will show up in promotion campaign. Restricted to UTF-8 characters with max length of 100 bytes.
     * @type {string}
     * @memberof EcommerceGetStorePromoRule200Response
     */
    'title'?: string;
    /**
     ...
     * @memberof EcommerceGetStorePromoRule200Response
     */
    'type'?: EcommerceGetStorePromoRule200ResponseTypeEnum;
    /**
     * The target that the discount applies to.
     * @type {string}
     * @memberof EcommerceGetStorePromoRule200Response
     */
    'target'?: EcommerceGetStorePromoRule200ResponseTargetEnum;
    /**
...
type EcommerceGetStorePromoRule200ResponseTypeEnum = 'fixed' | 'percentage'
type EcommerceGetStorePromoRule200ResponseTargetEnum = 'per_item' | 'total' | 'shipping'
