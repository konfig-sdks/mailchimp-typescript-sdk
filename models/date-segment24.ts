 ...
 * @export
 * @interface DateSegment24
 */
export interface DateSegment24 {
    /**
     * 
     * @type {string}
     * @memberof DateSegment24
     */
    'condition_type'?: DateSegment24ConditionTypeEnum;
    /**
...
type DateSegment24ConditionTypeEnum = 'Date'
type DateSegment24FieldEnum = 'timestamp_opt' | 'info_changed' | 'ecomm_date'
type DateSegment24OpEnum = 'greater' | 'less' | 'is' | 'not' | 'blank' | 'blank_not' | 'within' | 'notwithin'
