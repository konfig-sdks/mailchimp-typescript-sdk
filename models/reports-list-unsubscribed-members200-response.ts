 ...
 * @export
 * @interface ReportsListUnsubscribedMembers200Response
 */
export interface ReportsListUnsubscribedMembers200Response {
    /**
     * An array of objects, each representing a member who unsubscribed from a campaign.
     * @type {Array<Unsubscribes>}
     * @memberof ReportsListUnsubscribedMembers200Response
     */
