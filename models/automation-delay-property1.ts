 ...
 * @export
 * @interface AutomationDelayProperty1
 */
export interface AutomationDelayProperty1 {
    /**
     * The delay amount for an Automation email.
     * @type {number}
     * @memberof AutomationDelayProperty1
     */
    'amount'?: number;
    /**
     ...
     * @memberof AutomationDelayProperty1
     */
    'type'?: AutomationDelayProperty1TypeEnum;
    /**
     * Whether the delay settings describe before or after the delay action of an Automation email.
     * @type {string}
     * @memberof AutomationDelayProperty1
     */
    'direction'?: AutomationDelayProperty1DirectionEnum;
    /**
     * The action that triggers the delay of an Automation email.
     * @type {string}
     * @memberof AutomationDelayProperty1
     */
    'action'?: AutomationDelayProperty1ActionEnum;
    /**
