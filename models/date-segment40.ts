 ...
 * @export
 * @interface DateSegment40
 */
export interface DateSegment40 {
    /**
     * 
     * @type {string}
     * @memberof DateSegment40
     */
    'condition_type'?: DateSegment40ConditionTypeEnum;
    /**
...
type DateSegment40ConditionTypeEnum = 'Date'
type DateSegment40FieldEnum = 'timestamp_opt' | 'info_changed' | 'ecomm_date'
type DateSegment40OpEnum = 'greater' | 'less' | 'is' | 'not' | 'blank' | 'blank_not' | 'within' | 'notwithin'
