 ...
 * @export
 * @interface DateSegment43
 */
export interface DateSegment43 {
    /**
     * 
     * @type {string}
     * @memberof DateSegment43
     */
    'condition_type'?: DateSegment43ConditionTypeEnum;
    /**
...
type DateSegment43ConditionTypeEnum = 'Date'
type DateSegment43FieldEnum = 'timestamp_opt' | 'info_changed' | 'ecomm_date'
type DateSegment43OpEnum = 'greater' | 'less' | 'is' | 'not' | 'blank' | 'blank_not' | 'within' | 'notwithin'
