 ...
 * @export
 * @interface AimSegment39
 */
export interface AimSegment39 {
    /**
     * 
     * @type {string}
     * @memberof AimSegment39
     */
    'condition_type'?: AimSegment39ConditionTypeEnum;
    /**
     * Segment by interaction with a specific campaign.
     * @type {string}
     * @memberof AimSegment39
     */
    'field'?: AimSegment39FieldEnum;
    /**
...
type AimSegment39ConditionTypeEnum = 'Aim'
type AimSegment39FieldEnum = 'aim'
type AimSegment39OpEnum = 'open' | 'click' | 'sent' | 'noopen' | 'noclick' | 'nosent'
