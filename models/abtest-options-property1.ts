 ...
 * @export
 * @interface ABTestOptionsProperty1
 */
export interface ABTestOptionsProperty1 {
    /**
     * ID for the winning combination.
     * @type {string}
     * @memberof ABTestOptionsProperty1
     */
     ...
     * @memberof ABTestOptionsProperty1
     */
    'winner_criteria'?: ABTestOptionsProperty1WinnerCriteriaEnum;
    /**
...
type ABTestOptionsProperty1WinnerCriteriaEnum = 'opens' | 'clicks' | 'manual' | 'total_revenue'
