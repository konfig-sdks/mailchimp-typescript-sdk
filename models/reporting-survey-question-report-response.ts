 ...
 * @export
 * @interface ReportingSurveyQuestionReportResponse
 */
export interface ReportingSurveyQuestionReportResponse {
    /**
     * The ID of the survey question.
     * @type {string}
     * @memberof ReportingSurveyQuestionReportResponse
     */
    'id'?: string;
    /**
     ...
     * @memberof ReportingSurveyQuestionReportResponse
     */
    'type'?: ReportingSurveyQuestionReportResponseTypeEnum;
    /**
...
type ReportingSurveyQuestionReportResponseTypeEnum = 'pickOne' | 'pickMany' | 'range' | 'text' | 'email'
