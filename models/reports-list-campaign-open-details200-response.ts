 ...
 * @export
 * @interface ReportsListCampaignOpenDetails200Response
 */
export interface ReportsListCampaignOpenDetails200Response {
    /**
     ...
     * @memberof ReportsListCampaignOpenDetails200Response
     */
