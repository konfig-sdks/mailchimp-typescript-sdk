 ...
 * @export
 * @interface VerifiedDomainsVerifyDomainForSendingResponse
 */
export interface VerifiedDomainsVerifyDomainForSendingResponse {
    /**
     * The name of this domain.
     * @type {string}
     * @memberof VerifiedDomainsVerifyDomainForSendingResponse
     */
    'domain'?: string;
    /**
