...
export interface AutomationSegment {
     ...
     * 
     * @type {string}
     * @memberof AutomationSegment
     */
    'condition_type'?: AutomationSegmentConditionTypeEnum;
    /**
     * Segment by interaction with an Automation workflow.
     * @type {string}
     * @memberof AutomationSegment
     */
    'field': AutomationSegmentFieldEnum;
    /**
...
type AutomationSegmentConditionTypeEnum = 'Automation'
type AutomationSegmentFieldEnum = 'automation'
type AutomationSegmentOpEnum = 'started' | 'completed' | 'not_started' | 'not_completed'
