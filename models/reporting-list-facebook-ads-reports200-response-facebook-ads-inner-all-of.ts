 ...
 * 
 * @export
 * @interface ReportingListFacebookAdsReports200ResponseFacebookAdsInnerAllOf
 */
export interface ReportingListFacebookAdsReports200ResponseFacebookAdsInnerAllOf {
    /**
     * Unique ID of an Outreach.
     * @type {string}
     * @memberof ReportingListFacebookAdsReports200ResponseFacebookAdsInnerAllOf
     */
    'id'?: string;
    /**
     ...
     * @memberof ReportingListFacebookAdsReports200ResponseFacebookAdsInnerAllOf
     */
    'type'?: ReportingListFacebookAdsReports200ResponseFacebookAdsInnerAllOfTypeEnum;
    /**
     * The status of this outreach.
     * @type {string}
     * @memberof ReportingListFacebookAdsReports200ResponseFacebookAdsInnerAllOf
     */
    'status'?: ReportingListFacebookAdsReports200ResponseFacebookAdsInnerAllOfStatusEnum;
    /**
    ...
    /**
     * 
     * @type {RecipientsProperty3}
     * @memberof ReportingListFacebookAdsReports200ResponseFacebookAdsInnerAllOf
     */
    'recipients'?: RecipientsProperty3;
    /**
...
type ReportingListFacebookAdsReports200ResponseFacebookAdsInnerAllOfTypeEnum = 'regular' | 'email-touchpoint' | 'plaintext' | 'rss' | 'reconfirm' | 'variate' | 'absplit' | 'automation' | 'facebook' | 'google' | 'autoresponder' | 'transactional' | 'page' | 'website' | 'social_post' | 'survey' | 'customer_journey' | 'sms'
type ReportingListFacebookAdsReports200ResponseFacebookAdsInnerAllOfStatusEnum = 'save' | 'paused' | 'schedule' | 'scheduled' | 'sending' | 'sent' | 'canceled' | 'canceling' | 'active' | 'disconnected' | 'somepaused' | 'draft' | 'completed' | 'partialRejected' | 'pending' | 'rejected' | 'published' | 'unpublished'
