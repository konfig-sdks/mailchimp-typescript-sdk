 ...
 * @export
 * @interface AimSegment31
 */
export interface AimSegment31 {
    /**
     * 
     * @type {string}
     * @memberof AimSegment31
     */
    'condition_type'?: AimSegment31ConditionTypeEnum;
    /**
     * Segment by interaction with a specific campaign.
     * @type {string}
     * @memberof AimSegment31
     */
    'field'?: AimSegment31FieldEnum;
    /**
...
type AimSegment31ConditionTypeEnum = 'Aim'
type AimSegment31FieldEnum = 'aim'
type AimSegment31OpEnum = 'open' | 'click' | 'sent' | 'noopen' | 'noclick' | 'nosent'
